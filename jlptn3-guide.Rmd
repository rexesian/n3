...
##### **N4:**
```{r echo=FALSE, message=FALSE, error=FALSE}
dt_jlpt_n4 <- jlpt %>% slice(2057:2724)
...
##### **N3:**
```{r echo=FALSE, message=FALSE, error=FALSE}
dt_jlpt_n3 <- jlpt %>% slice(2726:4864)
...
##### **N2:**
```{r echo=FALSE, message=FALSE, error=FALSE}
dt_jlpt_n2 <- jlpt %>% slice(4866:6613)
...
##### **N1:**
```{r echo=FALSE, message=FALSE, error=FALSE}
dt_jlpt_n1 <- jlpt %>% slice(6615:9313)
